...
@property (strong,nonatomic) NSArray *weatherConditionResult;
...
-(void)copyDatabaseIntoDocumentsDirectory{
    NSString *destinationPath = [self.documentsDirectory stringByAppendingPathComponent:self.databaseFilename];//把路径和文件名相连就是文件目的地咯
